...
import { uploadSingle } from "../middleware/uploadMiddleware.ts";
...
router
  .route("/:id")
  .get(getProductById)
  .put(uploadSingle, updateProduct) // Add auth middleware when ready: protect, admin, uploadSingle, updateProduct
